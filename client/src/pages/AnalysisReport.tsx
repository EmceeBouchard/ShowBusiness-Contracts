...
export default function AnalysisReport() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen stage-gradient flex items-center justify-center">
...
LEGAL DISCLAIMER: This is a pattern-based diagnostic tool and not a substitute for legal advice from a qualified attorney.
  ...
  return (
    <div className="min-h-screen stage-gradient pb-16">
      <div className="container max-w-5xl mx-auto px-4 py-12">
        ...
        <Card className="p-6 mb-8 border-2 border-primary/30">
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-display text-2xl font-bold text-card-foreground mb-1" data-testid="text-overall-risk">
                  Overall Risk Level
                </h2>
        ...
        {redFlags.length > 0 && (
          <div className="mb-8">
            <h2 className="font-display text-2xl font-bold text-foreground mb-4 flex items-center gap-2" data-testid="heading-red-flags">
        ...
        {yellowFlags.length > 0 && (
          <div className="mb-8">
            <h2 className="font-display text-2xl font-bold text-foreground mb-4 flex items-center gap-2" data-testid="heading-yellow-flags">
        ...
        {greenFlags.length > 0 && (
          <div className="mb-8">
            <h2 className="font-display text-2xl font-bold text-foreground mb-4 flex items-center gap-2" data-testid="heading-green-flags">
        ...
        <Card className="p-8 mb-8 border-primary/40 bg-primary/10">
          <h2 className="font-display text-2xl font-bold text-card-foreground mb-4" data-testid="heading-final-summary">
            Final Summary & Strategic Recommendation
          </h2>
          
          <div className="space-y-4 text-sm text-card-foreground leading-relaxed">
            <div>
              <p className="font-semibold mb-2 text-card-foreground">Overall Risk Assessment</p>
              <p data-testid="text-risk-assessment" className="text-card-foreground">
            ...
            <div>
              <p className="font-semibold mb-2 text-card-foreground">Key Takeaways</p>
              <ul className="list-disc list-inside space-y-1 text-card-foreground" data-testid="text-key-takeaways">
                {redFlags.length > 0 && (
            ...
            <div>
              <p className="font-semibold mb-2 text-card-foreground">Next Steps</p>
              <p className="text-card-foreground" data-testid="text-next-steps">
                {analysis?.overallRiskLevel === "danger"
